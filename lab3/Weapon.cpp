...
Clip::Clip(int cap, int cal):capacity(cap), caliber(cal) {}
void Clip::getInfo() {
    cout << "capacity: " << capacity << endl << "caliber: " << caliber << endl;
}

Sheath::Sheath(int conv, int bea):convenience(conv), beauty(bea) {}
void Sheath::getInfo() {
    cout << "convenience: " << convenience << endl << "beauty: " << beauty << endl;
}
